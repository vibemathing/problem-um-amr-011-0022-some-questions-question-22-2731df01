...
```json
{
  ...
  "problem_contract": {
    ...
    "domain": {
      "description": "Draft source observation in Graph Theory; domain extraction is unresolved.",
      "objects": [
    ...
    "problem_id": "problem:um-amr-011-0022-some-questions-question-22-2731df01",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-amr-011-0022-444e57709d9e",
        "url": "https://www.unsolvedmath.com/problems/AMR-011-0022"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Can every ergodic unimodular random network that is almost surely an infinite tree be obtained as the limit of an expander family?",
      "version": 1
    },
    "title": "Some Questions — Question 22",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "a2df88338f6133deefa39280c3fcc9674820457111cb33233e0e198b9ba713c2"
}
```
